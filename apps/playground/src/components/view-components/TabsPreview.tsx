...
export const TabsExample = () => {
  ...
  return (
    <Tabs value={activeTab} onValueChange={setActiveTab}>
      <TabList>
        <TabTrigger value="tab1" borderWidth={4}>Tab 1</TabTrigger>
        <TabTrigger value="tab2" borderWidth={2}>Tab 2</TabTrigger>
        <TabTrigger value="tab3" borderWidth={5}>Tab 3</TabTrigger>
      </TabList>
