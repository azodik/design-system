  ...
  <div>
    <Accordion type="single" collapsible>
      <AccordionItem value="item-1">
        ...
        <AccordionContent>
          This is an accordion component that allows you to show and hide content sections. It's
          perfect for FAQs, documentation, or any collapsible content. The component provides a
          clean and professional interface for organizing information.
        </AccordionContent>
      </AccordionItem>
      ...
      <AccordionItem value="item-3">
        ...
        <AccordionContent>
          ...
          whether multiple items can be open at once. The component supports both controlled and
