...
interface MobilityIconProps {
  size?: number;
  className?: string;
  style?: React.CSSProperties;
}

const MobilityIcon: React.FC<MobilityIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
