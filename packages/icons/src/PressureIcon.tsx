...
interface PressureIconProps {
  size?: number;
  className?: string;
  style?: React.CSSProperties;
}

const PressureIcon: React.FC<PressureIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
