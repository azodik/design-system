...
interface Store2IconProps {
  size?: number;
  className?: string;
  style?: React.CSSProperties;
}

const Store2Icon: React.FC<Store2IconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
