...
interface ConsulIconProps {
  size?: number;
  className?: string;
  style?: React.CSSProperties;
}

const ConsulIcon: React.FC<ConsulIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
