...
const RedisIcon: React.FC<RedisIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
    ...
    >
      ...
      />
      <ellipse cx="38.4" cy="35.4" fill="currentColor" rx="15.5" ry="6" />
      <path fill="currentColor" d="m93.3 27.7l17.2 6.8l-17.2 6.8z" />
      <path fill="currentColor" d="m74.3 35.3l19-7.6v13.6l-1.9.8z" />
    </svg>
  );
};
