...
interface FaaSIconProps {
  size?: number;
  className?: string;
  style?: React.CSSProperties;
}

const FaaSIcon: React.FC<FaaSIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
