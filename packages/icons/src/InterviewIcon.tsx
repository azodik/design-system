...
const InterviewIcon: React.FC<InterviewIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
    ...
    >
      <g fill="currentColor">
        <ellipse cx="20" cy="26.021" strokeMiterlimit="10" strokeWidth="2" rx="13.8" ry="13.82" />
        <path d="M18.398 39.91C15.244 44.248 11 46 5 46c2.874-1.916 5.748-5.668 6.864-8.617z" />
        <circle cx="52" cy="41.28" r="13.8" strokeMiterlimit="10" strokeWidth="2" />
