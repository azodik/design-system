...
interface LinkerdIconProps {
  size?: number;
  className?: string;
  style?: React.CSSProperties;
}

const LinkerdIcon: React.FC<LinkerdIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
