...
interface GlacierIconProps {
  size?: number;
  className?: string;
  style?: React.CSSProperties;
}

const GlacierIcon: React.FC<GlacierIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
    ...
    >
      <defs>
        <linearGradient id="SVGTHZ4wdZV" x1="0%" x2="100%" y1="100%" y2="0%">
