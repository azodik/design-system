...
interface TraefikIconProps {
  size?: number;
  className?: string;
  style?: React.CSSProperties;
}

const TraefikIcon: React.FC<TraefikIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
