...
interface FetchIconProps {
  size?: number;
  className?: string;
  style?: React.CSSProperties;
}

const FetchIcon: React.FC<FetchIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
    ...
    >
      <circle cx="128" cy="128" r="115.2" fill="currentColor" />
      <path
        fill="currentColor"
        d="M128 0C57.308 0 0 57.308 0 128s57.308 128 128 128s128-57.308 128-128S198.692 0 128 0m0 25.6c56.554 0 102.4 45.846 102.4 102.4S184.554 230.4 128 230.4S25.6 184.554 25.6 128S71.446 25.6 128 25.6"
      />
      <path
        fill="currentColor"
