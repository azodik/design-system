...
interface RegionalIconProps {
  size?: number;
  className?: string;
  style?: React.CSSProperties;
}

const RegionalIcon: React.FC<RegionalIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
