...
interface FutureIconProps {
  size?: number;
  className?: string;
  style?: React.CSSProperties;
}

const FutureIcon: React.FC<FutureIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
