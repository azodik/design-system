...
interface BreakerIconProps {
  size?: number;
  className?: string;
  style?: React.CSSProperties;
}

const BreakerIcon: React.FC<BreakerIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
