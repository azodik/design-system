...
interface CloudMoonIconProps {
  size?: number;
  className?: string;
  style?: React.CSSProperties;
}

const CloudMoonIcon: React.FC<CloudMoonIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
