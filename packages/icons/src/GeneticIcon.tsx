...
interface GeneticIconProps {
  size?: number;
  className?: string;
  style?: React.CSSProperties;
}

const GeneticIcon: React.FC<GeneticIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
