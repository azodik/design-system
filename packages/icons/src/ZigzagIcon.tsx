...
interface ZigzagIconProps {
  size?: number;
  className?: string;
  style?: React.CSSProperties;
}

const ZigzagIcon: React.FC<ZigzagIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
