...
interface BiologyIconProps {
  size?: number;
  className?: string;
  style?: React.CSSProperties;
}

const BiologyIcon: React.FC<BiologyIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
