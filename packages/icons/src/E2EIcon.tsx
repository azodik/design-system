...
interface E2EIconProps {
  size?: number;
  className?: string;
  style?: React.CSSProperties;
}

const E2EIcon: React.FC<E2EIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
