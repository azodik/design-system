...
interface ThreeDSIconProps {
  size?: number;
  className?: string;
  style?: React.CSSProperties;
}

const ThreeDSIcon: React.FC<ThreeDSIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
    ...
    >
      ...
      />
      <path fill="currentColor" d="M23.188 0h85.75a6.5 6.5 0 0 1 6.5 6.5V90h-92.25z" />
      <path fill="currentColor" d="M23.188 90V0l-19.5 11.75v90z" />
      <path
        fill="currentColor"
