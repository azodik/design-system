...
interface SentenceIconProps {
  size?: number;
  className?: string;
  style?: React.CSSProperties;
}

const SentenceIcon: React.FC<SentenceIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
