...
interface StripesIconProps {
  size?: number;
  className?: string;
  style?: React.CSSProperties;
}

const StripesIcon: React.FC<StripesIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
