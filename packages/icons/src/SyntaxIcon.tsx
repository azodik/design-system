...
const SyntaxIcon: React.FC<SyntaxIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
    ...
    >
      <path
        fill="currentColor"
        d="m20.17 16l-2.58 2.58L19 20l4-4l-4-4l-1.42 1.41zm-8.34 0l2.58-2.58L13 12l-4 4l4 4l1.42-1.41z"
      />
      <path
        fill="currentColor"
