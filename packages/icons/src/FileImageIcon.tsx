...
const FileImageIcon: React.FC<FileImageIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
    ...
    >
      <path
        fill="currentColor"
        d="m6.22 8.14l-3.17 4.28c-.18.24 0 .58.29.58h6.32c.3 0 .47-.34.29-.58L6.8 8.14c-.14-.2-.44-.2-.58 0"
      />
      <path
        fill="currentColor"
        d="m9.72 10.09l-1.9 2.57c-.11.14 0 .35.17.35h3.79c.18 0 .28-.2.17-.35l-1.89-2.57a.215.215 0 0 0-.35 0Z"
      />
