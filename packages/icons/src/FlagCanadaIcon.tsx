...
interface FlagCanadaIconProps {
  size?: number;
  className?: string;
  style?: React.CSSProperties;
}

const FlagCanadaIcon: React.FC<FlagCanadaIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
    ...
    >
      ...
      <g mask="url(#SVGuywqVbel)">
        <path fill="#d80027" d="M0 0v512h144l112-64l112 64h144V0H368L256 64L144 0Z" />
