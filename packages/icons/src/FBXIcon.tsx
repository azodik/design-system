...
interface FBXIconProps {
  size?: number;
  className?: string;
  style?: React.CSSProperties;
}

const FBXIcon: React.FC<FBXIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
