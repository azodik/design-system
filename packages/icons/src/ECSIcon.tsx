...
interface ECSIconProps {
  size?: number;
  className?: string;
  style?: React.CSSProperties;
}

const ECSIcon: React.FC<ECSIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
    ...
    >
      <defs>
        <linearGradient id="SVGbGfcrvoV" x1="0%" x2="100%" y1="100%" y2="0%">
