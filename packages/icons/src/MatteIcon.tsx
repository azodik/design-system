...
interface MatteIconProps {
  size?: number;
  className?: string;
  style?: React.CSSProperties;
}

const MatteIcon: React.FC<MatteIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
