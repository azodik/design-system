...
const FileVideoIcon: React.FC<FileVideoIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
    ...
    >
      <path
        fill="currentColor"
        d="m5.65 11.94l4.14-2.56c.28-.17.28-.59 0-.76L5.65 6.06c-.29-.18-.65.04-.65.38v5.11c0 .34.36.56.65.38Z"
      />
      <path
        fill="currentColor"
