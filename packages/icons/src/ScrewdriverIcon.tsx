...
interface ScrewdriverIconProps {
  size?: number;
  className?: string;
  style?: React.CSSProperties;
}

const ScrewdriverIcon: React.FC<ScrewdriverIconProps> = ({ size = 20, className, style }) => {
  return (
    <svg
