...
const HeroTitle = ({ children, className = "", ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
  <Box as="h1" className={`az-Hero-title ${className}`} {...props}>
    {children}
  </Box>
);

const HeroDescription = ({ children, className = "", ...props }: React.HTMLAttributes<HTMLParagraphElement>) => (
