import { ThemeProvider, Button, Box } from "@azodik/ui";
    ...
    <div className="p-10 space-y-10">
      <section>
        <h2 className="text-xl font-bold mb-4">
          1. Custom Hex Color via ThemeProvider (New Feature)
        </h2>
      ...
      <section>
        ...
        <p className="text-sm text-gray-600 mb-2">
          Note: For style override to work, apply it at the root ThemeProvider level, not nested.
        </p>
        {/* Demonstrating that inline styles work on regular divs */}
        <div
          style={{ "--accent-9": "#D946EF" } as React.CSSProperties}
          className="p-4 border rounded"
        >
          <Button variant="solid">This won&apos;t be pink (no ThemeProvider context)</Button>
          <div className="mt-2" style={{ color: "#D946EF" }}>
            But this text is pink via direct style
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <ThemeProvider
          style={{ "--font-family-sans": "'Courier New', monospace" } as React.CSSProperties}
        >
          <Box className="p-4 border rounded">
